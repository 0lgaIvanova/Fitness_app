...
public class AddUserServiceTest {
    ...
    public void shouldReturnResponseWithErrorsWhenValidationFails() {
        AddUserRequest notValidRequest = new AddUserRequest(null, "Username", "Password");
    ...
    public void shouldAddUserToDatabaseWhenRequestIsValid() {
        AddUserRequest validRequest = new AddUserRequest("Email","Username", "Password");
        when(validator.validate(validRequest)).thenReturn(List.of());
        service.execute(validRequest);
        verify(userRepository).save(argThat(new UserMatcher("Email", "Username", "Password")));
    }
    @Test
